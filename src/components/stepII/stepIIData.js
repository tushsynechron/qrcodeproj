export const stepIIData = {
    english:{
        ...
        badgeValue:"Step 2",
        bullet_list:[
            "Launch <b>Word, Excel, OneNote and PowerPoint</b>to ensure they are functioning as expected",
            "Launch <b>Outlook</b> and check any shared mailboxes you previously had access to and try sending a test email",
          ],
          footer_text:
    ...
    french:{
        ...
        badgeValue:"Étape 2",
        bullet_list:[
            "Lancez <b>Word, Excel, OneNote et PowerPoint</b> pour vous assurer qu’elle fonctionne comme prévu. ",
            "Lancez <b>Outlook</b> et vérifiez les boîtes aux lettres partagées auxquelles vous aviez accès et tentez d’envoyer un courriel d’essai. ",
          ],
          footer_text:
